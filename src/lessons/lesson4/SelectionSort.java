...
public class SelectionSort {
    ...
    public static void selectionSort(double[] d, boolean inc) {
        ...
        // d.length - 1 because in findMinIdx/findMaxIdx is will require to check one index in front of the pass index
        // if the index that we pass is d.length - 1, the starting index we pointed to in both other method will be d.length
    ...
    public static int findMinIdx(double[] d, int k) {
        int minIdx = k;
        // i = k + 1 to make sure the current index we pointing to is one index in front of the minIdx
